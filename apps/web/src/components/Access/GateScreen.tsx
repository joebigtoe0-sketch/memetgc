...
export default function GateScreen() {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", width: "min(430px, calc(100% - 32px))", padding: "clamp(24px, 6vw, 34px)", borderRadius: 20, background: "linear-gradient(150deg,rgba(255,255,255,.05),rgba(14,18,28,.85))", border: "1px solid rgba(255,255,255,.1)", boxShadow: "0 24px 60px rgba(0,0,0,.5)" }}>
