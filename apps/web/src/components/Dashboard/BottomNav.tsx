...
export default function BottomNav({ active }: { active: Tab }) {
  ...
  return (
    <nav style={{ flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", gap: 28, padding: "12px 20px 14px", borderTop: "1px solid rgba(255,255,255,.07)", background: "rgba(8,11,18,.7)", backdropFilter: "blur(8px)", position: "relative" }}>
      ...
      <SettingsButton showLabel style={{ position: "absolute", right: 18, bottom: 10 }} />
    </nav>
  );
}
